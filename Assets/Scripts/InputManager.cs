...
public class InputManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, MAX_DISTANCE))
        {
            ...
            {
                Debug.Log("pointing at gnd surf");
            ...
            else
            {
                ...
                // Debug.Log("not pointing at gnd surf");
            }
    ...
    private void TriggerDown()
    {
        ...
        RaycastHit hit;
        // Debug.Log("in trigger down fcn");

        if (Physics.Raycast(ray, out hit, MAX_DISTANCE))
        {
            if (hit.collider.gameObject.tag == "GroundSurf")
            {
                Debug.Log("ground surf hit, should teleport");
